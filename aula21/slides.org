...
- Antes de apresentarmos a construção da fórmula $\varphi$ diretamente, vamos demonstrar  demonstração da incompletude seguindo uma abordagem baseada em redução.
