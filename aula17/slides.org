...
- Mostre como representar um autômato finito determinístico qualquer como um programa
  expresso pela máquina virtual apresentada. Prove que seu programa executa com sucesso em
  palavras aceitas pelo autômato representado.
